...
import os
# bash utils/single_gpu_test.sh configs/apes/apes_cls_global-modelnet-200epochs.py work_dirs/apes_cls_global-modelnet-200epochs/512p/20240723_092325/best_val_acc_epoch_171.pth
