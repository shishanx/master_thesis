...
def draw_scenes(points=None, keypoints=None, gt_boxes=None, roi_boxes=None, ref_boxes=None, ref_labels=None, ref_scores=None, point_colors=None, draw_origin=True, kp_color=0, index=None):
    ...
    vis.create_window(width=2200, height=600)
...
#        points = points[cur_target_points_in_roi.sum(axis=0)==1]
    ...
    view_control.set_zoom(0.06)
    vis.run()
    if index is not None:
        vis.capture_screen_image("train_image/" + str(index) + ".png", do_render=True)
    vis.destroy_window()
