...
class KittiDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        # self.downsampling = APESClsBackbone('global')
        # self.downsampling.cuda()
...
#                annotations['gt_boxes_lidar'] = gt_boxes_lidar
    ...
    def __getitem__(self, index):
        ...
        if "points" in get_item_list:
            ...
            input_dict['points_length'].append(len(points))
            if self.mode == 'test':
...
def farthest_point_sample(origin_points, n_samples):
    """
    points: [N, 3] array containing the whole point cloud
    n_samples: samples you want in the sampled point cloud typically << N 
    """
    points = np.array(origin_points[:, 0:3])
    ...
    for i in range(1, n_samples):
        ...
        # and all the others
        # print("sampling: " + str(i) + " / " + str(n_samples), end = "\r")
    ...
    return origin_points[sample_inds]
